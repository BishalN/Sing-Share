...
const sendForgetPasswordEmail = (email, token) => {
    ...
    **/
      ...
      *
      * ! For mobile specific styling, see .
    **/
                ...
                >
                  <tbody>
                    <tr>
                      <td style="border: 0; margin: 0; padding: 0">
                        <table
                          class="st-Header st-Header--simplified st-Width st-Width--mobile"
                          border="0"
                          cellpadding="0"
                          cellspacing="0"
                          width="600"
                        ...
                        >
                          <tbody>
                            ...
                            <tr>
                              ...
                              >
                                <div
                                  class="st-Header-area st-Target st-Target--mobile"
                                >
                                  <a
                                    style="
                                      border: 0;
                                  ...
                                  >
                                      <img
                                      class="st-Header-source"
                                        src="https://storage.googleapis.com/recordandshare-4e3f0.appspot.com/Sing%26Share.png" 
                                        alt="logo"
                                      />
                                    </div>
                                  </a>
                            ...
                            <tr>
                              ...
                              >
                                ...
                                >
                                  ...
                                  the Sing&Share account associated with ${email}.
                              ...
                              <td
                                ...
                                style="
                                  ...
                                  font-family: -apple-system, BlinkMacSystemFont,
                                    'Segoe UI', Roboto, 'Helvetica Neue', Ubuntu,
                                    sans-serif;
                                  font-size: 16px;
                                  line-height: 24px;
                                "
                        ...
                        >
                          <tbody>
                            <tr>
                              ...
                              >
                                We’ve received a request to reset the password for
                                the Sing&Share account associated with ${email}. No
                          ...
                          <tbody>
                            <tr>
                              ...
                              >
                                ...
                                <table
                                  class="st-Button st-Button--fullWidth"
                                  border="0"
                                  cellpadding="0"
                                  cellspacing="0"
                                  width="100%"
                                      ...
                                      >
                                        <a
                                          ...
                                          style="
                                            ...
                                            text-decoration: none;
                                          "
                                          href="http://localhost:3000/change-password?token=${token}"
                                        >
                                          <span
                                            class="st-Button-internal"
                                            style="
                                              border: 0;
                                              margin: 0;
                                              padding: 0;
                          ...
                          <tbody>
                            <tr>
                              ...
                              <td
                                ...
                                "
                              >
                                If you did not request a new password then ignore
                                this message
                              </td>
                              <td
                                class="st-Spacer st-Spacer--gutter"
                        ...
                        <table
                          class="st-Footer st-Width st-Width--mobile"
                          border="0"
                          cellpadding="0"
                          cellspacing="0"
                          width="600"
                        ...
                        >
                          <tbody>
                            ...
                            <tr>
                              ...
                              >
                                <span
                                  class="st-Delink st-Delink--footer"
                                  style="
                                    border: 0;
                                    margin: 0;
                                    padding: 0;
                            ...
                            <tr>
                              <td
                                class="st-Spacer st-Spacer--emailEnd"
                                colspan="3"
                                height="64"
                                style="
                                  border: 0;
